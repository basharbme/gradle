...
public class Instrumented {
    private static final Listener NO_OP = new Listener() {
        @Override
        public void systemPropertyQueried(String key, Class<?> consumer) {
        }
    };
    ...
    public static String systemProperty(String key, Class<?> consumer) {
        LISTENER.get().systemPropertyQueried(key, consumer);
        return System.getProperty(key);
    }

    public interface Listener {
        void systemPropertyQueried(String key, Class<?> consumer);
    }
}
